...
def get_df():
    df = pd.read_csv("C:/Users/Vishaali Naagaarjun/OneDrive/Desktop/CAPSTONE4/INDUSTRY_COPPER.csv").reset_index(drop= True)
    return df
...
def load_pickle_regg(quantity_tons,thickness,width,customer):
    ...
    if flag == 1:
        ...
        with open(r"D:\PROJ4\model.pkl", 'rb') as file:
            loaded_model = pickle.load(file)
        with open(r"D:\PROJ4\scaler.pkl", 'rb') as f:
            scaler_loaded = pickle.load(f)

        with open(r"D:\PROJ4\t.pkl", 'rb') as f:
            t_loaded = pickle.load(f)

        with open(r"D:\PROJ4\s.pkl", 'rb') as f:
...
def load_pickle_class(cquantity_tons,cthickness,cwidth,ccustomer,cselling):
    ...
    if cflag == 1:
        ...
        import pickle
        with open(r"D:\PROJ4\cmodel.pkl", 'rb') as file:
            cloaded_model = pickle.load(file)

        with open(r"D:\PROJ4\cscaler.pkl", 'rb') as f:
            cscaler_loaded = pickle.load(f)

        with open(r"D:\PROJ4\ct.pkl", 'rb') as f:
...
st.write( f'<h6 style="color:rgb(0, 153, 153,0.35);">App Created by VYSH', unsafe_allow_html=True )  
